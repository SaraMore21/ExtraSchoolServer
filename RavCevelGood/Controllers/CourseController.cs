...
namespace RavCevelGood.Controllers
{
    ...
    public class CourseController : ControllerBase
    {
        ...
        public IActionResult AddCoordinationsCourse([FromBody]ObjectCourseAndListSchools objectCourseAndListSchools, int YearbookId)
        {
            try
            {

                return Ok(_courseService.AddCoordinationsCourse(objectCourseAndListSchools, YearbookId));
            }
            catch (Exception e)
            {
                return BadRequest(e.InnerException != null ? e.InnerException.Message : e.Message);

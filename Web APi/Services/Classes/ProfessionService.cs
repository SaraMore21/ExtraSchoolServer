...
namespace Services.Classes
{
    public class ProfessionService : IProfessionService
    {
        ...
        public List<AppProfessionDTO> GetAllProfessionsByCoordinationId(int coordinationId)
        {
            return _mapper.Map<List<AppProfessionDTO>>( _professionRepository.GetAllProfessionsByCoordinationId(coordinationId));
        }
    }
}

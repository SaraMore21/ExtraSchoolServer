...
namespace DB.Model
{
    public partial class AppDocumentPerTaskExsist
    {
        public int IddocumentPerTaskExsist { get; set; }
        ...
        public int? RequiredDocumentPerTaskExsistId { get; set; }
        ...
        public virtual TabRequiredDocumentPerTaskExsist RequiredDocumentPerTaskExsist { get; set; }

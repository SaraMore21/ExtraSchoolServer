...
namespace Services.Classes
{
    public class UserService : IUserService
    {
        ...
        //החזרת רשימת משתמשים לפי רשימת IDUSER 
        public List<AppUserPerSchoolWithDetailsDTO> GetListUserDetailsByIDUser(int[][] listuser)
        {
            var a = _userRepository.GetListUserDetailsByIDUser(listuser);
            var x = _mapper.Map<List<AppUserPerSchoolWithDetailsDTO>>(a);
            return x;
        }

...
namespace RavCevelGood.Controllers
{
    ...
    public class ProfessionController : ControllerBase
    {
        ...
        [HttpGet("GetAllProfessionsByCoordinationId/{coordinationId}")]
        public IActionResult GetAllProfessionsByCoordinationId(int coordinationId)
        {
            try
            {
                return Ok(_professionService.GetAllProfessionsByCoordinationId(coordinationId));
            }
            catch (Exception e)
            {
                return BadRequest(e.Message ?? e.InnerException.Message);

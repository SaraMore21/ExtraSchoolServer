...
namespace DB.Model
{
    public partial class AppDocumentPerUser
    {
        public int IddocumentPerUser { get; set; }
        ...
        public int? RequiredDocumentPerUserId { get; set; }
        ...
        public virtual TabRequiredDocumentPerUser RequiredDocumentPerUser { get; set; }

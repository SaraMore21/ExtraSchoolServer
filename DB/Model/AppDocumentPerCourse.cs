...
namespace DB.Model
{
    public partial class AppDocumentPerCourse
    {
        public int IddocumentPerCourse { get; set; }
        ...
        public int? RequiredDocumentPerCourseId { get; set; }
        ...
        public virtual TabRequiredDocumentPerCourse RequiredDocumentPerCourse { get; set; }

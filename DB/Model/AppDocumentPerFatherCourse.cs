...
namespace DB.Model
{
    public partial class AppDocumentPerFatherCourse
    {
        ...
        public virtual AppCourse FatherCourse { get; set; }
        public virtual AppFolder Folder { get; set; }
        public virtual TabRequiredDocumentPerFatherCourse RequiredDocumentPerFatherCourse { get; set; }

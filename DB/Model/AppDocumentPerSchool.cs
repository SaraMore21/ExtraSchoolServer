...
namespace DB.Model
{
    public partial class AppDocumentPerSchool
    {
        public int IddocumentPerSchool { get; set; }
        ...
        public int? RequiredDocumentPerSchoolId { get; set; }
        ...
        public virtual TabRequiredDocumentPerSchool RequiredDocumentPerSchool { get; set; }

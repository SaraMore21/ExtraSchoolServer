...
namespace DB.Repository.Classes
{
    public class FatherCourseRepository : IFatherCourseRepository
    {
        ...
        public FatherCourseRepository(ExtraSchoolContext context, IUniqeCodeRepository uniqeCodeRepository, IUserRepository userRepository, IProfessionRepository professionRepository)
        {
            _context = context;
        ...
        //}
        public Tuple<AppCourse, AppProfession, AppUserPerSchool,int,int> AddCoordinationsFatherCourse(AppCourse fahterCourse, string ProfessioName, int CoustomerId, AppSchool school, int UserCreatedId, int YearbookId)
        {
            var Result = _professionRepository.CheckIfExsistAndAddProfession(school, ProfessioName, CoustomerId, UserCreatedId, YearbookId);
            fahterCourse.ProfessionId = Result.Item1.Idprofession;

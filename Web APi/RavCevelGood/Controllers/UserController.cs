...
namespace RavCevelGood.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        //IDשליפת  רשימת פרטי משתמש לפי 
        [HttpPut("GetListUserDetailsByIDUser")]
        public IActionResult GetListUserDetailsByIDUser([FromBody] int[][] ListUser)
        {
            return Ok(_userService.GetListUserDetailsByIDUser(ListUser));
        }

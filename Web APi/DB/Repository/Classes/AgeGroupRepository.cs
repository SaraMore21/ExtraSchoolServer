...
namespace DB.Repository.Classes
{
    public class AgeGroupRepository : IAgeGroupRepository
    {
        ...
        {
            return null;
                //_context.TabAgeGroups.Where(ag => ag.CoordinationCode == coordinationCode).Select(t=>t.Name).Distinct().ToList();
        }
        ...
        {
            return null;
                //_context.TabAgeGroups.FirstOrDefault(ag => ag.Name == name && ag.SchoolId == schoolId && ag.CoordinationCode == coordinationCode);
        }
